...
Nothing has been released or tagged yet: the brief is v1.0 as a working document, the site
...
- First public version: brief v1.0 as a machine-readable taxonomy, the interactive
